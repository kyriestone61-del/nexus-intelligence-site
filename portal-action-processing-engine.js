...
function renderClientActions(){
  ...
  const markup=`<header class="nexus-client-page-head compact action-engine-page-head"><div><div class="eyebrow">Action Items</div><h1>Every action. One clear next move.</h1><p>Start work, attach evidence, ask for help, comment, and hand completed work back to Relystra from one place.</p></div></header>
