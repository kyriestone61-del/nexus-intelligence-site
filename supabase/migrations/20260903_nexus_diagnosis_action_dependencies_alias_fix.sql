-- Fix PL/pgSQL variable/SQL alias collision in dependency mapper CTEs.
...
begin
  ...
  with dependency_rules as (
    ...
    select task_row.company_id,task_row.project_id,task_row.source_diagnosis_run_id,task_row.template_code,min(task_row.id) as parent_id
