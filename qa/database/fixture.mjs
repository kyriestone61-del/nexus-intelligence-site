...
export async function database(){
  ...
  const columns=JSON.parse(await read('baseline-columns.json'));
  ...
  const migrations=['20260907000100_relystra_prebuild_actions.sql','20260907000200_relystra_delivery_catalog.sql'];
