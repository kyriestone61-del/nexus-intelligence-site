(function(){
  ...
  const detail={
    manual:{title:'Reduce repetitive work',text:'Relystra maps repetitive handoffs, copying, routing, document preparation, and status-update work, then evaluates which steps are appropriate for automation.',examine:['Manual data entry and copying','Recurring document work','Routing, reminders, and status updates'],measure:['Handling time','Manual touchpoints','Rework and exception rate']},
    service:{title:'Improve customer response',text:'Relystra maps intake, triage, scheduling, response preparation, and exception routing, then designs a controlled workflow where the business case supports it.',examine:['Inquiry classification','Scheduling and intake','Response preparation and escalations'],measure:['Response time','Resolution time','Exception volume']},
    knowledge:{title:'Organize company knowledge',text:'Relystra organizes approved SOPs, policies, project information, and internal documents into a retrieval workflow with defined access and review boundaries.',examine:['SOP and policy retrieval','Document search','Internal knowledge assistance'],measure:['Search time','Repeat questions','Successful retrieval rate']},
    systems:{title:'Connect disconnected systems',text:'Relystra maps how information moves between email, spreadsheets, CRMs, documents, and operating systems, then evaluates which handoffs can be connected safely.',examine:['Cross-system handoffs','Duplicate data entry','Status synchronization'],measure:['Handoff time','Duplicate entry volume','Sync and exception rate']}
  };
