...
function renderAdminIntake(){
  ...
  <section class="box intake-card step2-module" data-module="diagnosis"><div class="step2-module-head"><div><div class="kicker">Diagnosis status</div><h2>Run Diagnosis</h2><p class="small">Relystra analyzes all authorized evidence, current admin context, and completed client discovery answers. All active discovery documents from Step 1 are included with supporting evidence.</p></div></div>${executionMarkup()}</section>
